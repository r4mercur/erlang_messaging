...
CREATE INDEX idx_msg_conv_id_id_desc ON message (conversation_id, id DESC);
CREATE INDEX idx_msg_conv_time ON message (conversation_id, sent_at DESC);
CREATE INDEX idx_msg_meta_gin ON message USING GIN (meta);